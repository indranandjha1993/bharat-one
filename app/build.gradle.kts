...
// Release signing is driven by a local, untracked keystore.properties (see docs/RELEASE.md).
// Without it, release still builds (unsigned) so debug work is unaffected.
